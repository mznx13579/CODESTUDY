...
from three_layer_net import ThreeLayerNet	# (784, 50, 30, 10) 형태의 3층 신경망
...
# 3층 신경망 초기화
network = ThreeLayerNet(input_size=784, hidden_1_size=50, hidden_2_size=30, output_size=10)
